          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            <div className="lg:col-span-1">
              ...
              <div className="space-y-3 mt-6">
                ...
                <button className="w-full flex items-center justify-center gap-2 py-2 shadow-sm rounded-lg font-medium bg-white">
                  <GoArchive /> Archive
                </button>
                <button className="w-full flex items-center justify-center gap-2 p py-2 text-red-500 shadow-sm rounded-lg font-medium bg-white">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-[20px] text-green-800 ">
                    Relationship Goal
                  </h2>
              ...
              <div className="bg-white rounded-lg shadow-sm p-5">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <button
                    onClick={handleCall}
                    className="flex flex-col items-center justify-center gap-3 p-6 bg-gray-50 shadow-sm hover:bg-gray-100 rounded-lg"
                  >
